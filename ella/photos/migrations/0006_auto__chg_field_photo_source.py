...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.source'
        db.alter_column('photos_photo', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Source'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Photo.source'
        db.alter_column('photos_photo', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Source'], null=True))
