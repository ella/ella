...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Category.tree_parent'
        db.alter_column('core_category', 'tree_parent_id', self.gf('ella.core.cache.fields.CategoryForeignKey')(null=True))

        # Changing field 'Listing.category'
        db.alter_column('core_listing', 'category_id', self.gf('ella.core.cache.fields.CategoryForeignKey')())

        # Changing field 'Publishable.category'
        db.alter_column('core_publishable', 'category_id', self.gf('ella.core.cache.fields.CategoryForeignKey')())

        # Changing field 'Author.user'
        db.alter_column('core_author', 'user_id', self.gf('ella.core.cache.fields.CachedForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        # Changing field 'Category.tree_parent'
        db.alter_column('core_category', 'tree_parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Category'], null=True))

        # Changing field 'Listing.category'
        db.alter_column('core_listing', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Category']))

        # Changing field 'Publishable.category'
        db.alter_column('core_publishable', 'category_id', self.gf('ella.core.cache.fields.CachedForeignKey')(to=orm['core.Category']))

        # Changing field 'Author.user'
        db.alter_column('core_author', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 14, 16, 43, 4, 353560)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 14, 16, 43, 4, 353475)'}),
        ...
        'core.author': {
            ...
            'user': ('ella.core.cache.fields.CachedForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'core.category': {
            ...
            'tree_parent': ('ella.core.cache.fields.CategoryForeignKey', [], {'null': 'True', 'blank': 'True'}),
        ...
        'core.listing': {
            ...
            'category': ('ella.core.cache.fields.CategoryForeignKey', [], {}),
