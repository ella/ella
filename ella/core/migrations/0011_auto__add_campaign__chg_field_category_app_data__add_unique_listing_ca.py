...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_campaign', (
            ...
            ('mpu', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('leader', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('coupon', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('sponsorship', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
        ))
        ...
        # Adding unique constraint on 'Listing', fields ['category', 'publishable']
        db.create_unique('core_listing', ['category_id', 'publishable_id'])

        # Adding field 'Publishable.campaign'
        db.add_column('core_publishable', 'campaign',
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Listing', fields ['category', 'publishable']
        db.delete_unique('core_listing', ['category_id', 'publishable_id'])
        ...
        # Deleting field 'Publishable.campaign'
        db.delete_column('core_publishable', 'campaign_id')
    ...
    models = {
        ...
        'core.campaign': {
            ...
            'coupon': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leader': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'mpu': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'sponsorship': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
