...
#    priority_from = models.DateTimeField(auto_now_add=True, verbose_name=_("Setup Priority From Date"))
#    priority_till = models.DateTimeField(verbose_name=_("Setup priority till Date"))
#    priority_value = models.IntegerField()
#    publish_till = models.DateTimeField()
