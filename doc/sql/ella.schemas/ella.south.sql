...
CREATE TABLE `answers_question` (
  ...
  `timelimit` datetime NOT NULL DEFAULT '2009-06-02 15:14:59',
  PRIMARY KEY (`id`),
...
CREATE TABLE `articles_article` (
  ...
  `created` datetime NOT NULL DEFAULT '2009-05-19 15:13:57',
...
CREATE TABLE `attachments_attachment` (
  ...
  `photo_id` int(11) DEFAULT NULL,
  `description` longtext COLLATE utf8_czech_ci NOT NULL,
  `created` datetime NOT NULL DEFAULT '2009-05-19 15:14:55',
...
) ENGINE=InnoDB AUTO_INCREMENT=457 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `auth_user` VALUES (1,'admin','','','a@a.cz','sha1$0994c$aefd45e5673dce4b94e7e559e88e71fd3e8fca60',1,1,1,'2009-05-19 15:13:39','2009-05-19 15:13:39');
...
CREATE TABLE `comments_comment` (
  ...
  `submit_date` datetime NOT NULL DEFAULT '2009-05-19 15:14:04',
...
CREATE TABLE `comments_commentoptions` (
  ...
  `timestamp` datetime NOT NULL DEFAULT '2009-05-19 15:14:04',
  PRIMARY KEY (`id`),
...
CREATE TABLE `contact_form_message` (
  ...
  `content` longtext COLLATE utf8_czech_ci NOT NULL,
  `created` datetime NOT NULL DEFAULT '2009-05-19 15:16:02',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `discussions_topic` (
  ...
  `category_id` int(11) NOT NULL,
  `photo_id` int(11) DEFAULT NULL,
  `created` datetime NOT NULL DEFAULT '2009-05-19 15:14:37',
  PRIMARY KEY (`id`),
...
CREATE TABLE `galleries_gallery` (
  ...
  `created` datetime NOT NULL DEFAULT '2009-05-19 15:14:11',
  PRIMARY KEY (`id`),
...
CREATE TABLE `instruction_instruction` (
  ...
  `description` longtext COLLATE utf8_czech_ci NOT NULL,
  `text` longtext COLLATE utf8_czech_ci NOT NULL,
  `created` datetime NOT NULL DEFAULT '2009-05-19 15:15:08',
  `updated` datetime DEFAULT NULL,
...
CREATE TABLE `interviews_answer` (
  ...
  `submit_date` datetime NOT NULL DEFAULT '2009-05-19 15:14:42',
  `content` longtext COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `media_media` (
  ...
  `description` longtext COLLATE utf8_czech_ci NOT NULL,
  `text` longtext COLLATE utf8_czech_ci NOT NULL,
  `created` datetime NOT NULL DEFAULT '2009-05-19 15:15:04',
  `updated` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `photos_photo` (
  ...
  `height` int(10) unsigned NOT NULL,
  `source_id` int(11) DEFAULT NULL,
  `created` datetime NOT NULL DEFAULT '2009-05-19 15:13:55',
  PRIMARY KEY (`id`),
...
CREATE TABLE `ratings_rating` (
  ...
  `target_ct_id` int(11) NOT NULL,
  `target_id` int(10) unsigned NOT NULL,
  `time` datetime NOT NULL DEFAULT '2009-05-19 15:14:28',
  `user_id` int(11) DEFAULT NULL,
  `amount` decimal(10,2) NOT NULL,
...
CREATE TABLE `sendmail_mail` (
  ...
  `sent` datetime NOT NULL DEFAULT '2009-05-19 15:14:53',
  `target_ct_id` int(11) NOT NULL,
  `target_id` int(10) unsigned NOT NULL,
...
INSERT INTO `south_migrationhistory` VALUES (1,'core','0001_initial','2009-05-19 13:13:52'),(2,'photos','0001_initial','2009-05-19 13:13:57'),(3,'articles','0001_initial','2009-05-19 13:13:57'),(4,'comments','0001_initial','2009-05-19 13:14:05'),(5,'db_templates','0001_initial','2009-05-19 13:14:09'),(6,'galleries','0001_initial','2009-05-19 13:14:12'),(7,'polls','0001_initial','2009-05-19 13:14:16'),(8,'tagging','0001_initial','2009-05-19 13:14:26'),(9,'ratings','0001_initial','2009-05-19 13:14:29'),(10,'exports','0001_initial','2009-05-19 13:14:32'),(11,'imports','0001_initial','2009-05-19 13:14:34'),(12,'ellaadmin','0001_initial','2009-05-19 13:14:36'),(13,'discussions','0001_initial','2009-05-19 13:14:39'),(14,'interviews','0001_initial','2009-05-19 13:14:45'),(15,'positions','0001_initial','2009-05-19 13:14:48'),(16,'catlocks','0001_initial','2009-05-19 13:14:51'),(17,'sendmail','0001_initial','2009-05-19 13:14:53'),(18,'attachments','0001_initial','2009-05-19 13:14:58'),(19,'answers','0001_initial','2009-05-19 13:15:00'),(20,'series','0001_initial','2009-05-19 13:15:02'),(21,'media','0001_initial','2009-05-19 13:15:05'),(22,'instruction','0001_initial','2009-05-19 13:15:09'),(23,'recipes','0001_initial','2009-05-19 13:15:16'),(24,'astrology','0001_initial','2009-05-19 13:15:38'),(25,'contact_form','0001_initial','2009-05-19 13:16:02'),(26,'adverts','0001_initial','2009-05-19 13:16:05');
...
-- Dump completed on 2009-05-19 13:16:24
